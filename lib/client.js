...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const ROW_CSS = [
			...
			'min-height:140px;overflow:hidden;resize:vertical;border:1px solid var(--dsw-alias-border-l2);',
			'border-radius:12px;background:var(--dsw-alias-bg-layer-1);--dshCc-line:19px;',
			...
			'.dshCc_main{align-items:stretch;display:flex;gap:8px;width:100%;min-width:0}',
			...
			'.dshCc_foot{align-items:center;justify-content:space-between;gap:8px;display:flex}',
			...
			'.dshCc_fileBar{box-sizing:border-box;display:flex;align-items:center;gap:10px;width:100%;margin-bottom:6px;padding:6px 10px 6px 11px;border:1px solid var(--dsw-alias-border-l2);border-radius:10px;background:var(--dsw-alias-bg-module-platform)}',
