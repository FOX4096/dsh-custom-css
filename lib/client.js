...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const ROW_CSS = [
			...
			'.dshCc_addPropWrap{max-width:240px}',
			'.dshCc_select{box-sizing:border-box;display:flex;align-items:center;gap:6px;width:100%;min-width:0;height:24px;padding:0 6px;',
			'border:1px solid var(--dsw-alias-border-l2);border-radius:6px;background:var(--dsw-alias-bg-module-platform);',
			'color:var(--dsw-alias-label-primary);font:inherit;font-size:11px;text-align:left;cursor:pointer}',
			...
			'.dshCc_selectValue{flex:1;min-width:0;overflow:hidden;white-space:nowrap;text-overflow:ellipsis}',
			...
			'.dshCc_selectItem{display:flex;align-items:center;gap:6px;min-height:26px;padding:2px 8px;border:none;border-radius:10px;',
			...
			'.dshCc_partRow{display:flex;gap:4px;min-width:0;flex:1 1 auto}',
