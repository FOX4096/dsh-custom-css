	...
	factory: (require) => {
		...
		function CustomCssRow() {
			...
			const actionsList = () => [
				...
				// A whole-sheet action like the four above, and disabled exactly when it would
				...
				// Last, and the one entry that does not close the menu: it turns the menu
				// over to the versions page.
				{
					key: 'versions',
					label: '历史版本',
					hint: '回到之前的某一版',
