...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const ROW_CSS = [
			...
			'.dshCc_panel{box-sizing:border-box;display:flex;flex-direction:column;gap:8px;width:100%;min-width:0;',
			...
			'.dshCc_propGrid{box-sizing:border-box;display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:8px 12px;width:100%;min-width:0}',
			...
			'.dshCc_addPropWrap{max-width:260px}',
			'.dshCc_addPropWrap .dshCc_select{height:32px;border-radius:16px;padding:0 12px;background:var(--dsw-alias-interactive-bg-hover);border-color:transparent;font-size:13px}',
			'.dshCc_addPropWrap .dshCc_select:hover{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-label-primary)}',
			'.dshCc_select{box-sizing:border-box;display:flex;align-items:center;gap:6px;width:100%;min-width:0;height:30px;padding:0 10px;',
			'border:1px solid var(--dsw-alias-border-l2);border-radius:8px;background:var(--dsw-alias-bg-module-platform);',
			'color:var(--dsw-alias-label-primary);font:inherit;font-size:13px;line-height:18px;font-family:var(--dshCc-mono);text-align:left;cursor:pointer}',
			...
			'.dshCc_selectValue{flex:1;min-width:0;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;font-size:12px}',
			...
			'.dshCc_selectItem{display:flex;align-items:center;gap:6px;min-height:32px;padding:4px 10px;border:none;border-radius:10px;',
			...
			'.dshCc_partRow{display:flex;gap:6px;min-width:0;flex:1 1 auto}',
			'.dshCc_partRow .dshCc_propText{flex:1 1 0;min-width:0}',
			'.dshCc_tplGrid{box-sizing:border-box;display:grid;grid-template-columns:repeat(auto-fill,minmax(112px,1fr));gap:8px;width:100%;min-width:0}',
			'.dshCc_panelHead{align-items:center;display:flex;gap:6px}',
			'.dshCc_panelName{flex:1;min-width:0;box-sizing:border-box;height:30px;padding:0 10px;',
			'border:1px solid var(--dsw-alias-border-l2);border-radius:8px;background:var(--dsw-alias-bg-module-platform);',
			'color:var(--dsw-alias-label-primary);font:inherit;font-size:13px;font-family:var(--dshCc-mono)}',
			...
			'.dshCc_propText{flex:1;min-width:0;max-width:100%;box-sizing:border-box;height:30px;padding:0 10px;',
			'border:1px solid var(--dsw-alias-border-l2);border-radius:8px;background:var(--dsw-alias-bg-module-platform);',
			'color:var(--dsw-alias-label-primary);font:inherit;font-size:13px;line-height:18px;font-family:var(--dshCc-mono)}',
			...
			'.dshCc_tpl{display:flex;align-items:center;gap:6px;width:100%;min-width:0;min-height:32px;padding:5px 10px;',
			...
			return React.createElement(
				...
				React.createElement(
					...
					openRule === null ? null : React.createElement(
						...
						// The add-property control sits directly under the selector, above the grid:
						// below the declarations it would fall outside the panel's scroll window and
						// read as part of the template section instead of a toolbar.
									...
									if (parts !== undefined && !slashForm) {
										...
										return React.createElement(
											...
											React.createElement(
												...
												...parts.map((part, index) => React.createElement('input', {
													key: part.label,
													className: 'dshCc_propText',
													'aria-label': label + ' · ' + part.label,
													title: label + ' · ' + part.label,
													placeholder: part.label + ' · ' + part.hint,
													spellCheck: false,
													value: tokens[index] ?? '',
													onChange: (event) => {
