...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const ROW_CSS = [
			...
			'.dshCc_addPropWrap{max-width:300px}',
			...
			'.dshCc_selectValue{flex:1;min-width:0;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;font-size:14px}',
			...
			'.dshCc_propWide{grid-column:1 / -1;align-items:flex-end}',
			'.dshCc_partRow{display:flex;align-items:flex-start;gap:8px;min-width:0;flex:1 1 auto}',
			'.dshCc_partCell{display:flex;flex-direction:column;gap:3px;min-width:0;flex:1 1 0}',
			'.dshCc_partName{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:14px}',
			...
			'.dshCc_panelName{flex:1;min-width:0;box-sizing:border-box;height:36px;padding:0 14px;',
			'border:1px solid var(--dsw-alias-border-l2);border-radius:18px;background:var(--dsw-alias-bg-module-platform);',
			...
			'.dshCc_panelClose{appearance:none;flex:none;width:30px;height:30px;padding:0;border:none;border-radius:15px;',
