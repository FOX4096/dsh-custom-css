...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const ROW_CSS = [
			...
			'min-height:0;max-height:260px;overflow-y:auto;padding:10px;border:1px solid var(--dsw-alias-border-l2);',
			...
			'.dshCc_addProp{box-sizing:border-box;display:block;margin:2px 0 0;max-width:240px;height:24px;padding:0 6px;',
			'border:1px solid var(--dsw-alias-border-l2);border-radius:6px;background:var(--dsw-alias-bg-module-platform);',
			'color:var(--dsw-alias-label-primary);font:inherit;font-size:11px;cursor:pointer}',
