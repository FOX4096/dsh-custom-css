...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const ROW_CSS = [
			...
			'.dshCc_main{align-items:stretch;display:flex;flex-direction:column;gap:8px;width:100%;min-width:0;padding:8px}',
			...
			'.dshCc_panel{flex:none;box-sizing:border-box;display:flex;flex-direction:column;gap:8px;width:100%;',
			...
			'.dshCc_propGrid{display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:6px 10px}',
			...
			'.dshCc_tplGrid{display:grid;grid-template-columns:repeat(auto-fill,minmax(104px,1fr));gap:6px}',
